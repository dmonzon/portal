...
<head>
    ...
    <title>Asignación de casos por censo al personal de UR</title>
</head>
    ...
    <div id="empleados"> 
        ...
        <!-- </table> -->
            ...
            <div id="newEmp" name="newEmp" style="float: left; width: 30%; padding-top: 10px; padding-left: 10px;">
                <form id="fNewEmp" action="censo.php" target="_self" method="post">
        ...
        <div id="enabler" class="mystyle">
            <?php
                ...
                while ($r = sqlsrv_fetch_array($res, SQLSRV_FETCH_ASSOC)) {
                    ...
                    $html .= '<form id="frmEmul'.$id.'" name="frmEmul'.$id.'" method="POST" action="censo.php">
